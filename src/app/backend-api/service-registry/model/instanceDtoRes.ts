...
export interface InstanceDtoRes { 
    comment: string;
    docIds?: Array<number>;
    endpointType?: string;
    endpointUri?: string;
    ...
    ledgerRequestStatus?: InstanceDtoRes.LedgerRequestStatusEnum;
    mmsi?: string;
    name: string;
    organizationId?: string;
    publishedAt?: string;
    serviceType?: Array<string>;
    status: InstanceDtoRes.StatusEnum;
    unlocode?: Array<string>;
    version: string;
}
export namespace InstanceDtoRes {
