...
import { GeometryReq } from './geometryReq';
import { Xml } from './xml';


export interface InstanceDtoReq { 
    comment: string;
    docIds?: Array<number>;
    endpointType?: string;
    endpointUri?: string;
    ...
    ledgerRequestStatus?: InstanceDtoReq.LedgerRequestStatusEnum;
    mmsi?: string;
    name: string;
    organizationId?: string;
    publishedAt?: string;
    serviceType?: Array<string>;
    status: InstanceDtoReq.StatusEnum;
    unlocode?: Array<string>;
    version: string;
}
export namespace InstanceDtoReq {
